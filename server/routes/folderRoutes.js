...
import { validateFolderCreate, validateFolderUpdate, validateFolderDeckAdd } from '../middleware/validators.js';
...
router.route('/')
  ...
  .post(protect, validateFolderCreate, createFolder); // POST /api/folders - create folder (auth required)
...
router.route('/:id')
  ...
  .put(protect, validateFolderUpdate, updateFolder) // PUT /api/folders/:id - update folder (auth required)
...
router.route('/:id/decks')
  .post(protect, validateFolderDeckAdd, addDeckToFolder); // POST /api/folders/:id/decks - add deck to folder (auth required)
